...
$menu_schedule = '';
//GALLERY
$n_menu_gallery = 'nav-active';
$menu_gallery = 'menu-active';
//PERFORMANCE
$n_menu_performance = '';
$menu_performance = '';
//SHOP
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="gallery-list">
                    <?php
                        $sql = mysqli_query($condb, "SELECT * FROM gallery WHERE picture_category='photo' ORDER BY id DESC LIMIT 5");
                        if(mysqli_num_rows($sql) == 0){
                            echo '<div class="mt-5 mb-5"><h3 class="nene-font-color">Photo not found</h3></div>';
                        } else {
                            while ($row = mysqli_fetch_assoc($sql)) {
                                echo '
                                <div class="card card-color card-margin" style="width: 12rem;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="gallery-list">
                    <?php
                        $sql = mysqli_query($condb, "SELECT * FROM gallery WHERE picture_category='item' ORDER BY id DESC LIMIT 5");
                        if(mysqli_num_rows($sql) == 0){
